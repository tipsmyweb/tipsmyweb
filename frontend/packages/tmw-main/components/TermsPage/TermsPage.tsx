            ...
            <div className={styles.termsPage}>
                ...
                <div className={styles.content}>
                    ...
                    <p>
                        ...
                        full. Do not continue to use Tips myWeb&apos;s website if you do not accept
                    ...
                    <p>
                        ...
                        the Client and ourselves, or either the Client or ourselves. All terms refer
                        ...
                        subject to, prevailing law of France. Any use of the above terminology or
                        other words in the singular, plural, capitalisation and/or he/she or they,
                        are taken as interchangeable and therefore as referring to same.
                    </p>
                    <p className={styles.subtitle}>Cookies</p>
                    <p>
                        We employ the use of cookies. By using Tips myWeb&apos;s website you consent
                        to the use of cookies in accordance with Tips myWeb&apos;s privacy policy.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        intellectual property rights for all material on Tips myWeb. All
                        intellectual property rights are reserved. You may view and/or print pages
                        from http://tipsmyweb.com/ for your own personal use subject to restrictions
                    ...
                    <p>
                        Redistribute content from Tips myWeb (unless content is specifically made
                        for redistribution).
                    </p>
                    ...
                    <p>
                        ...
                        visibility associated with the hyperlink outweighs the absence of Tips
                        myWeb; and (d) where the link is in the context of general resource
                    ...
                    <p>
                        No use of Tips myWeb&apos;s logo or other artwork will be allowed for
